...
| **프론트 엔드** | 1. 카카오 로그인 버튼 클릭 시 카카오 OAuth 인증 진행 <br> 2. ☰ 메뉴에는 로그인/로그아웃 버튼과 지난 고민 보기, 피드백 버튼이 있음 <br> 3. 로그인 후 접근 권한 체크 (학교 정보, 밴 상태, 재가입 제한 등) <br> 4. 첫 로그인 시 학교 선택 페이지로 이동 |
