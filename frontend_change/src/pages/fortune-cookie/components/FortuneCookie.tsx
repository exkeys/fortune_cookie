    ...
    <div className="relative flex items-center justify-center p-8">
      ...
      >
        <div className={`relative ${isOpening ? 'animate-pulse' : ''}`}>
          ...
          <div className={`relative transition-all duration-700 ${showCracked ? 'opacity-0 transform rotate-45 scale-75' : 'opacity-100'}`}>
            <img
          ...
          <div className={`absolute top-0 left-0 transition-all duration-700 ${showCracked ? 'opacity-100' : 'opacity-0'}`}>
            ...
            {isOpened && (
              <div className="absolute -top-16 left-1/2 transform -translate-x-1/2 animate-slide-up">
                <div className="relative">
                  {/* 종이 그림자 - 더 큰 크기 */}
                  <div className="absolute top-2 left-2 w-28 h-20 bg-gray-400 rounded-lg opacity-20 blur-sm"></div>
                  
                  {/* 종이 - 더 큰 크기 */}
                  <div className="w-28 h-20 bg-gradient-to-b from-amber-50 via-white to-amber-50 rounded-lg shadow-2xl border-2 border-amber-200 flex items-center justify-center transform rotate-2 animate-float">
                    <div className="text-center px-3 py-2">
                      <div className="text-xs text-gray-600 leading-tight space-y-1">
                        ...
                        <div className="w-14 h-0.5 bg-amber-500 mx-auto rounded-full"></div>
                        <div className="w-10 h-0.5 bg-amber-400 mx-auto rounded-full"></div>
                        <div className="w-13 h-0.5 bg-amber-500 mx-auto rounded-full"></div>
      ...
      {!isOpened && !isOpening && (
        <div className="absolute -bottom-12 left-1/2 transform -translate-x-1/2 text-amber-600 text-lg font-bold animate-bounce bg-white px-4 py-2 rounded-full shadow-lg border-2 border-amber-200">
