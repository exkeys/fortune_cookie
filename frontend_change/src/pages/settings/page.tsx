        ...
        <div style={{ padding: "12px 0" }}>
          ...
          <div 
            ...
            onMouseEnter={(e) => {
              ...
              if (iconWrapper) {
                iconWrapper.style.background = "#1428A0";
                const icon = iconWrapper.querySelector('.menu-icon') as HTMLElement;
            ...
            onMouseLeave={(e) => {
              ...
              const iconWrapper = e.currentTarget.querySelector('.icon-wrapper') as HTMLElement;
              if (iconWrapper) {
                iconWrapper.style.background = "#F0F4FF";
                const icon = iconWrapper.querySelector('.menu-icon') as HTMLElement;
                if (icon) icon.style.color = "#1428A0";
              }
              const chevron = e.currentTarget.querySelector('.chevron') as HTMLElement;
              if (chevron) {
          ...
          >
            <div style={{
              ...
              <div className="icon-wrapper" style={{
                ...
                <FileText className="menu-icon" size={20} color="#1428A0" />
              </div>
              <span style={{
                fontSize: "15px",
                fontWeight: 600,
          ...
          >
            <div style={{
              ...
              <div className="icon-wrapper" style={{
                ...
                <MessageSquare className="menu-icon" size={20} color="#1428A0" />
              </div>
              <span style={{
                fontSize: "15px",
                fontWeight: 600,
        ...
        <div style={{ padding: "12px 0" }}>
          ...
          >
            <div style={{
              ...
              <div className="icon-wrapper" style={{
                ...
                <LogOut className="menu-icon" size={20} color="#1428A0" />
              </div>
              <span style={{
                fontSize: "15px",
                fontWeight: 600,
          ...
          <div 
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.transform = "translateX(2px)";
              const iconWrapper = e.currentTarget.querySelector('.icon-wrapper-danger') as HTMLElement;
              if (iconWrapper) {
                iconWrapper.style.background = "#DC2626";
                const icon = iconWrapper.querySelector('.menu-icon-danger') as HTMLElement;
                if (icon) icon.style.color = "white";
              }
            }}
            onMouseLeave={(e) => {
          ...
          >
            <div style={{
              ...
              <div className="icon-wrapper-danger" style={{
                width: "40px",
                height: "40px",
                background: "#FEE2E2",
                borderRadius: "10px",
                ...
                <Trash2 className="menu-icon-danger" size={20} color="#DC2626" />
              </div>
              <span style={{
                fontSize: "15px",
                fontWeight: 600,
