  ...
  useEffect(() => {
    const checkAdminAndLoadData = async () => {
      ...
      try {
        ...
        // 대시보드 통계 가져오기 - 백엔드에서 모든 통계를 한 번에 계산
        ...
        if (dashboardResponse.ok) {
          ...
          setStats({
            ...
            totalFortunes: dashboardData.totalFortunes ?? 0,
            todayFortunes: dashboardData.todayFortunes ?? 0,
            totalAdmins: dashboardData.totalAdmins ?? 0,
            schoolStats: dashboardData.schoolStats || []
          });
        } else {
          // 대시보드 API 실패 시 기본값 설정
          setStats({
            totalUsers: 0,
            totalFortunes: 0,
            todayFortunes: 0,
