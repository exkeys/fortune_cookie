          ...
          <div className="fixed top-20 md:top-24 right-3 bg-white rounded-xl shadow-2xl z-50 p-6 md:p-8 min-w-64 md:min-w-72 animate-fade-in">
            <div className="space-y-3 md:space-y-4">
              {!isLoggedIn ? (
                <button
                  onClick={handleLogin}
                  className="w-full flex items-center space-x-3 md:space-x-4 px-4 py-3 md:py-4 text-left hover:bg-amber-50 rounded-lg transition-colors duration-300 group"
                >
                  <i className="ri-login-circle-line text-amber-600 group-hover:text-amber-700 text-xl md:text-2xl"></i>
                  <span className="font-medium text-gray-700 group-hover:text-gray-800 text-base md:text-lg lg:text-xl">로그인</span>
                </button>
              ) : (
                <button
                  onClick={handleLogout}
                  className="w-full flex items-center space-x-3 md:space-x-4 px-4 py-3 md:py-4 text-left hover:bg-red-50 rounded-lg transition-colors duration-300 group"
                >
                  <i className="ri-logout-circle-line text-red-600 group-hover:text-red-700 text-xl md:text-2xl"></i>
                  <span className="font-medium text-gray-700 group-hover:text-gray-800 text-base md:text-lg lg:text-xl">로그아웃</span>
                </button>
              )}
              ...
              <button
                ...
                className="w-full flex items-center space-x-3 md:space-x-4 px-4 py-3 md:py-4 text-left hover:bg-blue-50 rounded-lg transition-colors duration-300 group"
              >
                <i className="ri-history-line text-blue-600 group-hover:text-blue-700 text-xl md:text-2xl"></i>
                <span className="font-medium text-gray-700 group-hover:text-gray-800 text-base md:text-lg lg:text-xl">이전 운세 기록 보기</span>
              </button>
              
              <button
                onClick={handleFeedback}
                className="w-full flex items-center space-x-3 md:space-x-4 px-4 py-3 md:py-4 text-left hover:bg-green-50 rounded-lg transition-colors duration-300 group"
              >
                <i className="ri-feedback-line text-green-600 group-hover:text-green-700 text-xl md:text-2xl"></i>
                <span className="font-medium text-gray-700 group-hover:text-gray-800 text-base md:text-lg lg:text-xl">피드백</span>
              </button>
            </div>
          </div>
        </>
